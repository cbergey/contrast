...
var experiment = {
	...
	processOneRow: function() {
		...
		dataforRound += "," + experiment.sizeasked + "," + experiment.targetsize;
		...
		if (phase == "search") {
			...
			if (experiment.searchtype == "contrast") {
				...
				for (i = 0; i < stimslist.length; i++) {
					if (stimslist[i] == "target") {
						...
						experiment.objects[i][0] = "" + experiment.targetshape; 
						experiment.objects[i][1] = "" + experiment.distractorsize;
			...
			if (usesound) {
				if (experiment.sizeasked == true) {
					trialsound = experiment.trialsounds[experiment.allstims.indexOf(experiment.targetsize+experiment.targetword)]
				} else {
