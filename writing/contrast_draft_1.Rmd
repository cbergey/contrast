...
While these descriptions use deterministic language for clarity, the model's computation is probabilistic and thus reflects tendencies to choose those objects rather than fixed rules. Figure \ref{e1-model} shows model predictions alongside people's behavior for the size contrast condition in Experiment 1.
