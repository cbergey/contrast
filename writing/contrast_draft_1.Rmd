...
e2_size_parameter <- webppl(program_file =
...
e2_color_parameter <- webppl(program_file =
                           here("webppl/infer_e2_params.wppl"), 
...
e2_parameters <- e2_size_parameter %>%
  bind_rows(e2_color_parameter)
...
[add something about e3 alien language condition]
