...
plot_model2 <- ggplot(e2_mean_data, aes(x = adjective, y = empirical_stat, 
                         color = condition)) + 
  facet_wrap(~ searchtype) +
