...
Participants were told they would play a game in which they would search for strange alien fruits. There were eight trials in total. Half of the trials were contrastive displays and half were unique target displays (filler trials). Half of trials had audio instructions with no adjective (e.g., "Find the toma"; the *noun* utterance type), and half of audio instructions with an adjective that described the critical feature of the target (e.g., "Find the small toma" or "Find the red toma"; the *adjective noun* utterance type). A label was randomly chosen at each trial from a list of eight novel words: blicket, wug, toma, gade, sprock, koba, zorp, and lomet. 
